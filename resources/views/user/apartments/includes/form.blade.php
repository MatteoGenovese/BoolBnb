    ...
    <div class="col-5 col-sm-4 col-lg-2 mt-4">
        ...
        @forelse ($services as $service)
            ...
            @if ($errors->any())
                ...
                <input name="services[]"
                id="services"
                class="form-check-input  services-check"
                value="{{ $service->id }}"
                type="checkbox"
                role="switch"
...
<div class="row">
    ...
    <div class="col-6 col-md-3">
        <div class="form-group mt-4 position-relative">
            ...
            name="bathroom_no"
            value="{{ old('bathroom_no', $apartment->bathroom_no) }}">
    ...
    <div class="col-6 col-md-3">
        ...
        <div class="form-group mt-4 position-relative">
            ...
            name="bed_no"
            value="{{ old('bed_no', $apartment->bed_no) }}">
    ...
    <div class="col-6 col-md-3">
        <div class="form-group mt-4 position-relative">
            ...
            name="room_no"
            value="{{ old('room_no', $apartment->room_no) }}">
    ...
    <div class="col-6 col-md-3">
        <div class="form-group mt-4 position-relative">
            ...
            id="square-meters"
            class="form-control"
            placeholder="Inserisci il numero di metri quadri dell'abitazione"
            name="square_meters"
        ...
        <div class="col-2">
            <div class="form-check form-switch">
                ...
                @else
                    ...
                    id="available-check"
                    class="form-check-input"
                    value="1" {{ $apartment->is_available == 1 ? "checked" : " " }}>
                @endif
