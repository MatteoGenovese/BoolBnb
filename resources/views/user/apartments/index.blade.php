                ...
                <tbody>
                    @forelse ($apartments as $apartment)
                        <tr class="align">
                            ...
                            <td class="text-center">{{ $apartment->messages->count() }}</td>
                            <td class="text-center">
                                ...
                                <a class="btn btn-warning m-1" href="{{ route('user.apartments.edit', $apartment->id) }}">
                                ...
                                {{ route('user.apartments.assignSponsorship', $apartment->id )}}
                                " >
